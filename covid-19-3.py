...
def plotCases( row, column, listCountries, data, diagramTitle ):
    data.plot(ax=axes[row,column], x ='date', y=listCountries, kind = 'line', title = diagramTitle, grid = True, fontsize = 6, figsize = ( 8, 8.3 ) )
...
selectedCountries = ['Poland', 'Germany', 'Sweden', 'South Korea', 'Spain', 'Italy', 'Czech Republic']
